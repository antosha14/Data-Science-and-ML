...
bool monka {true};// 1 byte 

int main(){

    //Declare and initialize the variables
    float number1 {1.12345678901234567890f}; // Precision : 7 If we dont youse f  compiler can think its a double and chop off a part of this number
